    ...
    <section ref={ref} className={`card lift-reveal ${active ? "is-visible" : ""}`}>
      ...
      <div className="cardB">
          ...
          <div className="lab-group lab-group--other">
            ...
            <div className="lab-links">
              <ul className="doc-list">
                ...
                <li>
                  <a href="#/llm">Small LLM — in-browser inference and tokenizer/manifest pipeline</a>
                </li>
              </ul>
            </div>
          </div>
        ...
        <p className="muted doc-footnote">
          Interactive training and browser inference live under <a href="#/llm">Small LLM</a>. The{" "}
